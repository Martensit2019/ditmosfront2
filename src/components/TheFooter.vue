    ...
    <div class="footer__inner">
      <div class="footer__top">
        <div class="footer__coll footer__logos">
          <AppLogoOpenControl color="#ffffff" class="footer__open-control" />
          <div class="mosblizon">
            <div class="mosblizon__svg">
              <AppLogoMoscowBlazon color="#ffffff" />
            </div>
        ...
        <div class="footer__coll">
          ...
          <a href="https://knd.mos.ru/event-calendar-public" class="footer__link"
            >Календарь контрольных дат</a
          >
        ...
        <div class="footer__video">
          <div class="video-story" @click="openDialogVideo">
            <div class="video-story__preview">
              <img
                src="../assets/i/icon_play_dark.svg"
                class="video-story__play"
                alt="Рассказываем о работе с порталом"
              />
            </div>
